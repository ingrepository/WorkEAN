    ...
    if energia >= 1: 
        ...
        if manzana>0:
            ...
            if (manza > 0) and (cont >=7):
                print("En hora buena :) tienes reserva y has recorrido",cont,"pasos\ndesde la ultima comida y sin toparte con un goloso.\Ahora puedes adquirir energia")
                energia=energia+7
                manza=manza-1
                cont=0
        ...
        if object_here("tulip"):
            ...
            take("tulip")
            if medicina>0:
                print("Gracias a la medicina soy inmune :)")
        ...
        if object_here("token"):
            ...
            if manza >0:
                ...
                print("No tengo manzanas recolectadas")
        if medicina>0:
                tulipan=0
        if tulipan == 0:
            print("Reeboorg actualmente esta sano") 
        else:
       ...
       #El break aqui no es valido , no encuentro la forma de cerrar el ciclo cuando no tiene energia
