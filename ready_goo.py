...
def camino_recto(energia,cont,manzana,manza,tulipan,medicina,goloso,pasos):
...
goloso=0
pasos=0
camino_recto(energia,cont,manzana,manza,tulipan,medicina,goloso,pasos)
print(camino_recto(energia,cont,manzana,manza,tulipan,medicina,goloso,pasos))
print("2)Total numero de pasos dado por Reboorg:",pasos)
print("Energia actual:",energia)
